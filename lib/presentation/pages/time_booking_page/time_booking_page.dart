...
import 'package:ticketorium_app_project/presentation/widgets/selectable_card.dart';
            ...
            children: [
              ...
              Padding(
                ...
                child: NetworkImageCard(
                  ...
                  borderRadius: 15,
                  imageUrl: 'https://image.tmdb.org/t/p/w500${widget.movieDetail.backdropPath ?? widget.movieDetail.posterPath}',
                  fit: BoxFit.cover,
                ),
              ),
              ...options(
              ...
              ...options(
                ...
                isOptionEnable: (hour) => selectedDate != null && 
                DateTime(selectedDate!.year, selectedDate!.month, 
                selectedDate!.day, hour).isAfter(DateTime.now()),
                onTap: (object) => setState(() {
                  selectedHour = object;
                }),
              ),

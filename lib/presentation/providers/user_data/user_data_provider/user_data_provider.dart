...
import 'package:ticketorium_app_project/domain/usecases/get_logged_in_user/get_logged_in_user.dart';
...
import 'package:ticketorium_app_project/presentation/providers/usecase/get_logged_in_user_provider/get_logged_in_user_provider.dart';
import 'package:ticketorium_app_project/presentation/providers/usecase/login_provider/login_provider.dart';
import 'package:ticketorium_app_project/presentation/providers/usecase/logout_provider/logout_provider.dart';
import 'package:ticketorium_app_project/presentation/providers/usecase/register_provider/register_provider.dart';
import 'package:ticketorium_app_project/presentation/providers/usecase/top_up_provider/top_up_provider.dart';
import 'package:ticketorium_app_project/presentation/providers/usecase/upload_profile_picture_provider/upload_profile_picture_provider.dart';
...
class UserData extends _$UserData {
  ...
  Future<void> login({required String email, required String password}) async {
    ...
    switch(result){
      case Success(value: final user): _getMovies();
  ...
  Future<void> uploadProfilePicture({required User user, required File imageFile}) async {
    ...
    var result = await uploadProfilePicture(UploadProfilePictureParam(user, imageFile: imageFile));
